...
<head>
  ...
  <link rel="stylesheet" href="css/dashUs.css">
...
<body>
  <header class="header">
    ...
    <section class="section-show grid">
      <div class="menu">
        <a class="menu-sub" href="sell.php">Sell or Buy Cycle</a>
        <a class="menu-sub" href="hire.php">Hire or Rent Cycle</a>
      </div>
      <div>
        <h1 class="history">Your History</h1>
